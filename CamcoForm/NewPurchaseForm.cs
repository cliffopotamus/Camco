...
namespace CamcoForm
{
    public partial class NewPurchaseForm : Form
    {
        ...
        private void NewPurchaseForm_Load(object sender, EventArgs e)
        {
       ...
       public void getVendorID(string vendName)
        ...
        public void setAddress(int vendID)
        {
            textVendorID.Text = vendID.ToString();
            using (var DB = new CamcoEntities())
            {
                Vendor result = DB.Vendors.SingleOrDefault(x => x.VendorID == vendID);
                
                if ( result != null)
                {
                    textAddress.Text = result.VendorAddress;
                    textCity.Text = result.VendorCity;
                    textZip.Text = result.VendorZip;
                    textState.Text = result.VendorState;
                }
            }
        }
        ...
        public void setDetails(string PurchaseSO)
        {
            using (var DB = new CamcoEntities())
            {
                ...
                textSONumber.Text = result.PurchaseSO;
                textPONumber.Text = result.PurchasePO;
            }
        }
        ...
        private void comboVendorName_SelectedIndexChanged(object sender, EventArgs e)
        {
